...
<?php get_header(); ?>
        ...
        <div class="blog-nav">
            <div class="mp-nav">
                <ul>
                    <li><a href="<?php
      echo  get_permalink( get_page_by_path( 'Podcast' ) )
?>" class="navItem" id="b-nav"><div class="active-"></div>پادکست</a></li>
                    <li><a href="#" class="navItem" id="active"><div class="active-"></div>  ویدیو</a></li>
        ...
        $args = array(
            ...
            <div class="s6-post">
                <div class="s6-pic">
                    <img src="<?php echo get_template_directory_uri() .'/assets/Images/video-camera 1.svg'?>" alt="" id="category">
                    <?php 
